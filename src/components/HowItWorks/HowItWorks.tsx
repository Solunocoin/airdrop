      ...
      <div className={styles.howItWorks}>
        <div className={styles.howItWorksCard}>
          ...
          <p>
            ...
            our Telegram group{' '}
            <a href="https://twitter.com/solunocoin">(@solunocoin)</a>. Fill out
            the form <a href="#application">above</a>.
          </p>
        </div>
        <div className={styles.howItWorksCard}>
          ...
          <p>
            ...
            account and are part of our telegram group. We will run a validation
            check everyday.
          </p>
        </div>
        <div className={styles.howItWorksCard}>
          ...
          <h3>Reward</h3>
          <p>
            When Soluno launches sometime in May, you will receive your airdrop
            in your wallet automatically.
          </p>
        </div>
      </div>
    </Container>
